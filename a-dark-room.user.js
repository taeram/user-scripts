...
var main = function () {
    var HelperView = Backbone.View.extend({
        ...
        maxWorkers: function () {
            State.game.population = 1000;
            State.game.workers['armourer'] = 100;
            State.game.workers["charcutier"] = 100;
            State.game.workers["hunter"] = 100;
            State.game.workers["steelworker"] = 100;
            State.game.workers["tanner"] = 100;
            State.game.workers["trapper"] = 100;
            State.game.workers["iron miner"] = 100;
            State.game.workers["coal miner"] = 100;
            State.game.workers["sulphur miner"] = 100;
        ...
        parseEvents: function () {
            if (this.roomStoke) {
                if (Room.temperature.value <= 3 && !$('#stokeButton').hasClass('disabled')) {
...
// Wait for the external resources to be loaded
var init = function () {
    if (unsafeWindow.Backbone !== undefined && unsafeWindow._ !== undefined) {
        main();
    } else {
        setTimeout(init, 100);
    }
